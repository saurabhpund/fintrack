        ...
        <header className="text-gray-600 body-font bg-white dark:bg-gray-900 shadow-md">
          <div className="container mx-auto flex  px-10 py-2 flex-col md:flex-row justify-between items-center">
            ...
            <div className="inline-block">
              <button
                className="inline-flex mr-3 text-white items-center bg-blue-500 border-0 py-1 px-3 focus:outline-none hover:bg-blue-600 rounded-full text-base mt-4 md:mt-0"
              ...
              <button
                ...
                className="inline-flex items-center bg-red-500 ml-3  text-white py-2 px-4 rounded-md dark:text-white hover:text-gray-900 dark:hover:text-white"
              >
                Logout
              </button>
            </div>
